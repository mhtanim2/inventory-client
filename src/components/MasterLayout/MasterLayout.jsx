...
const MasterLayout = (props) => {
  ...
  const sidebarItems = [
    ...
    },
    {
      ...
      subMenu: [
        ...
        },
        {
          title: "New Expense",
          icon: (
            <RiDashboardLine size={16} className="side-bar-subitem-icon" />
          ),
          url: "/ExpenseCreateUpdatePage",
        },
        {
          title: "Expense List",
          icon: <MdFiberManualRecord size={16} className="side-bar-subitem-icon" />,
          url: "/ExpenseListPage",
        },
      ],
    },
    {
      title: "Product",
      icon: <BsAlarm className="side-bar-item-icon" />,
      url: "/Product",
      subMenu: [
        {
          title: "New Brand",
    ...
    {
      title: "Purchase",
      icon: <BsArchive className="side-bar-item-icon" />,
      url: "/Purchase",
      subMenu: [
        {
          title: "New Purchase",
    ...
    {
      title: "Sale",
      icon: <BsConeStriped className="side-bar-item-icon" />,
      url: "/Sale",
      subMenu: [
        {
          title: "New Sale",
